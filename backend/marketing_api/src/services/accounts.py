...
from src.services.senders import select_sender_by_id, select_sender_account_link
...
def _check_account(account: Account):
    if not account or not account.is_active:
        raise HTTPException(
            ...
            detail="No such account or account is inactive"
        )