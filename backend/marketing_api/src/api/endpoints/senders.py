...
from src.services.senders import check_sender_account_link, select_sender_by_id, select_mail_headers_for_sender, select_mail_for_sender, create_sender
from src.schemas import MailHeaderResponse, MailResponse, SenderResponse, SenderRegisterPayload
from src.db import get_db
from src.models import User, AccountType
from src.api.dependencies import current_logged_in_user, check_if_admin
...
@router.post("/senders/register", dependencies=[Depends(check_if_admin)], response_model=SenderResponse, status_code=status.HTTP_201_CREATED)
